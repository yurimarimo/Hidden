...
public class DimensionClassSeparativenessCombi2 {
	public static int NUMDIV = 10;
	public static int MAX_NUM_CLASS = 20;
	public static double support = 0.075;
	public static double confidence = 0.1;
	public static boolean allowDuplicate = false;
	...
	static void findClassSeparatingDimensions(ArrayList<ArrayList> allsets) {
		...
		for(int k = 0; k < numclass; k++) {
			...
			/*
			for(int j = 0; j < iset.getNumNumeric(); j++) {
				for(int jj = 0; jj < counter2[j].length; jj++) {
					System.out.print(counter2[j][jj] + ",");
				}
				System.out.println("");
			}
			*/
